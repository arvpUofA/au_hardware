...
#
# Acoustic_Modem_Basys3.tcl: Tcl script for re-creating project 'Acoustic_Modem_Basys3'
#
# Generated by Vivado on Sun Jan 22 22:04:37 -0700 2023
...
#
# 1. This project restoration tcl script (Acoustic_Modem_Basys3.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Github/au_hardware/acoustic_modem/Acoustic_Modem_Basys3/Acoustic_Modem_Basys3.srcs/sources_1/new/top_level.vhd"
#    "C:/Github/au_hardware/acoustic_modem/Acoustic_Modem_Basys3/Acoustic_Modem_Basys3.srcs/constrs_1/new/Basys3_Master.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Acoustic_Modem_Basys3/Acoustic_Modem_Basys3.srcs/sources_1/new/top_level.vhd"]"\
 "[file normalize "$origin_dir/Acoustic_Modem_Basys3/Acoustic_Modem_Basys3.srcs/constrs_1/new/Basys3_Master.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "Acoustic_Modem_Basys3"
...
set script_file "Acoustic_Modem_Basys3.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/Acoustic_Modem_Basys3"]"
...
set files [list \
 [file normalize "${origin_dir}/hdl/top_level.vhd" ]\
]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Acoustic_Modem_Basys3.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Acoustic_Modem_Basys3.srcs/utils_1/imports/impl_1" -objects $obj
